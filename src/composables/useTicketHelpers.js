...
// ── Categorías ─────────────────────────────────────────────────────────────
const CAT_ICON  = { cancelacion_documento: 'cancel', falla_pvwin: 'computer', falla_computadora: 'desktop_windows', otro: 'help_outline' }
const CAT_LABEL = { cancelacion_documento: 'Cancelación', falla_pvwin: 'Falla PVWIN', falla_computadora: 'Falla Equipo', otro: 'Otro' }
const CAT_COLOR = { cancelacion_documento: 'negative', falla_pvwin: 'primary', falla_computadora: 'warning', otro: 'grey' }
const CAT_BG    = { cancelacion_documento: 'rgba(193,0,21,0.08)', falla_pvwin: 'rgba(25,118,210,0.1)', falla_computadora: 'rgba(242,192,55,0.1)', otro: 'rgba(0,0,0,0.05)' }
...
// ── Tipo documento ─────────────────────────────────────────────────────────
const TIPO_DOC_LABEL = { factura: 'Factura', remision: 'Remisión', traspaso: 'Traspaso', compra: 'Compra', nota_credito: 'Nota de Crédito', devolucion: 'Devolución', otro: 'Otro' }
